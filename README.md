# Portfolio - Awaneesh Vikram Singh

A modern, professional portfolio website built with React, featuring smooth animations and an attractive design.

## 🚀 Features

- **Responsive Design**: Works seamlessly across all devices
- **Smooth Animations**: Beautiful animations using Framer Motion and AOS
- **Professional Layout**: Clean and modern UI/UX
...
2. **About** - Professional background and quick facts
3. **Skills** - Technical expertise with progress indicators
4. **Experience** - Detailed work history with projects
